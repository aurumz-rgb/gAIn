...
def get_file_hash(file_obj):
    """Generates a SHA-256 hash for a file object to detect duplicates."""
    file_obj.seek(0)
...
def estimate_confidence(text, mode="screener", criteria_dict=None, extracted_data=None, fields_list=None):
    ...
    - Extractor: Check how much extracted data matches paper content.
    """
...
"""
                ...
                if raw_result:
                     ...
                     update_terminal_log("No valid response to parse. Using defaults.", "WARN")
